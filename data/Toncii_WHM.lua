...
function get_sets()
	...
	send_command('@input /macro book 1;wait 5;gs c jpdetect;')
...
function handle_ping()
	...
	if buffactive['petrification'] then
		if os.clock()-lastChat > 20 then
			send_command('input /p Stona me, I am Petrified.')
			lastChat = os.clock()
		end
	elseif buffactive['sleep'] then
		if os.clock()-lastChat > 20 then
			send_command('input /p ZzZzz!')
			lastChat = os.clock()
		end
	end
