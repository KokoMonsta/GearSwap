...
--default macro set
	...
	sets.precast.bardsong= set_combine(sets.precast.fc, {
			main="Kali",
			sub="Genbu's Shield",
			head="Fili Calot +1",
	...
	sets.precast.ws["Mordant Rime"]={
		range="Gjallarhorn",
    head={ name="Bihu Roundlet +2", augments={'Enhances "Con Anima" effect',}},
	...
	sets.midcast.songbuff["Knight's Minne"]= set_combine(sets.midcast.songbuff, {range="Gjallarhorn", legs="Mousai Seraweels +1",})
	sets.midcast.songbuff["Knight's Minne II"]= set_combine(sets.midcast.songbuff, {range="Gjallarhorn", legs="Mousai Seraweels +1",})
	sets.midcast.songbuff["Knight's Minne III"]= set_combine(sets.midcast.songbuff, {range="Gjallarhorn", legs="Mousai Seraweels +1",})
	sets.midcast.songbuff["Knight's Minne IV"]= set_combine(sets.midcast.songbuff, {range="Gjallarhorn", legs="Mousai Seraweels +1",})
	sets.midcast.songbuff["Knight's Minne V"]= set_combine(sets.midcast.songbuff, {range="Gjallarhorn", legs="Mousai Seraweels +1",})
	...
	sets.midcast.songbuff["Army's Paeon"]= set_combine(sets.midcast.songbuff, {range="Gjallarhorn", head="Brioso Roundlet +2",})
	sets.midcast.songbuff["Army's Paeon II"]= set_combine(sets.midcast.songbuff, {range="Gjallarhorn", head="Brioso Roundlet +2",})
	sets.midcast.songbuff["Army's Paeon III"]= set_combine(sets.midcast.songbuff, {range="Gjallarhorn", head="Brioso Roundlet +2",})
	sets.midcast.songbuff["Army's Paeon IV"]= set_combine(sets.midcast.songbuff, {range="Gjallarhorn", head="Brioso Roundlet +2",})
	sets.midcast.songbuff["Army's Paeon V"]= set_combine(sets.midcast.songbuff, {range="Gjallarhorn", head="Brioso Roundlet +2",})
	sets.midcast.songbuff["Army's Paeon VI"]= set_combine(sets.midcast.songbuff, {range="Gjallarhorn", head="Brioso Roundlet +2",})
	...
	sets.midcast.songenfeeb["Foe Lullaby"]= set_combine(sets.midcast.songenfeeb, {Range="Gjallarhorn", hands="Brioso Cuffs +2", legs="Inyanga Shalwar +2", feet="Brioso Slippers +2",})
	sets.midcast.songenfeeb["Foe Lullaby II"]= set_combine(sets.midcast.songenfeeb, {Range="Gjallarhorn", hands="Brioso Cuffs +2", legs="Inyanga Shalwar +2", feet="Brioso Slippers +2",})

	sets.midcast.songenfeeb["Horde Lullaby"]= set_combine(sets.midcast.songenfeeb, {range="Marsyas", hands="Brioso Cuffs +2", legs="Inyanga Shalwar +2", feet="Brioso Slippers +2",})
	sets.midcast.songenfeeb["Horde Lullaby II"]= set_combine(sets.midcast.songenfeeb, {range="Marsyas", hands="Brioso Cuffs +2", legs="Inyanga Shalwar +2", feet="Brioso Slippers +2",})
