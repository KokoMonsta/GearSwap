...
function get_sets()
	...
	sets.QD = {
			...
			waist="Eschan Stone",
			legs={ name="Herculean Trousers", augments={'"Mag.Atk.Bns."+24','Pet: "Mag.Atk.Bns."+23','Mag. Acc.+18 "Mag.Atk.Bns."+18',}},
			feet={ name="Herculean Boots", augments={'"Mag.Atk.Bns."+19','INT+5','Mag. Acc.+17 "Mag.Atk.Bns."+17',}}}
	...
	sets.Midshot = {
			...
			waist="Yemaya Belt",
			legs="Adhemar Kecks",
			feet={ name="Herculean Boots", augments={'Rng.Acc.+22 Rng.Atk.+22','"Rapid Shot"+2','AGI+10','Rng.Acc.+9','Rng.Atk.+13',}},}
	...
	sets.Melee = {
			...
			legs="Meg. Chausses +2",
			feet={ name="Herculean Boots", augments={'Rng.Atk.+15','"Triple Atk."+4','STR+4','Accuracy+13','Attack+7',}},}
	...
	sets.WS.Wildfire = {
			ammo="Chrono Bullet",
			head={ name="Herculean Helm", augments={'Mag. Acc.+18 "Mag.Atk.Bns."+18','Crit.hit rate+1','INT+1','Mag. Acc.+13','"Mag.Atk.Bns."+13',}},
