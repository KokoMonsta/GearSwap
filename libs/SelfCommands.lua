...
function handle_set(cmdParams)
    if #cmdParams == 0 then
        add_to_chat(123,'Libs: Set parameter failure: field not specified.')
        return
    end
    ...
    if state_var then
        ...
        add_to_chat(123,'Libs: Set: Unknown field ['..cmdParams[1]..']')
    end
...
function handle_reset(cmdParams)
    ...
    elseif job_reset_state then
        ...
        add_to_chat(123,'Libs: Reset: Unknown field ['..cmdParams[1]..']')
    end
end
...
function handle_cycle(cmdParams)
    if #cmdParams == 0 then
        add_to_chat(123,'Libs: Cycle parameter failure: field not specified.')
        return
    end
    ...
    if state_var then
        ...
        add_to_chat(123,'Libs: Cycle: Unknown field ['..cmdParams[1]..']')
    end
end
...
function handle_toggle(cmdParams)
    if #cmdParams == 0 then
        add_to_chat(123,'Libs: Toggle parameter failure: field not specified.')
        return
    end
    ...
    if state_var then
        ...
        add_to_chat(123,'Libs: Toggle: Unknown field ['..cmdParams[1]..']')
    end
end
...
function handle_unset(cmdParams)
    if #cmdParams == 0 then
        add_to_chat(123,'Libs: Unset parameter failure: field not specified.')
        return
    end
